#!/usr/bin/env python3
"""Generate chapter 04 act content SQL migration (run once, output to stdout or file)."""
...
SCORED = (
    '{"pizza":{"mode":"scored","maxSlices":2,"minRatioToComplete":0.01,'
    '"rounding":"floor","mapping":{"kind":"linear"}},'
    '"backpack":{"mode":"first_completion","value":1}}'
)

INVITE_BODY = """INVITO — Divertiti nella Pianura Padana!
...
GERMAN_ARTICLE = """Wie tröste ich jemanden bei Liebeskummer?
...
VOCAB = [
    ...
    ("lasciare", "to leave"),
    ("l'emozione", "emotion"),
    ("rivolere (il partner)", "to want one's partner back"),
    ("piangere", "to cry"),
    ...
    ("TVB (Ti voglio bene)", "I love you (friendship)"),
    ...
    ("tirare su", "to cheer up"),
    ("guastare", "to spoil"),
    ("pentirsi di qc.", "to regret something"),
    ("lasciarsi", "to break up"),
    ("il senso", "sense / meaning"),
    ("estivo, -a", "summery"),
    ("girare", "to wander / to go around"),
...
def dq(tag: str, obj: dict) -> str:
    return f"${tag}${json.dumps(obj, ensure_ascii=False, indent=2)}${tag}$"


def main() -> None:
    pool_pairs = [
        {"id": f"v{i:02d}", "leftLabel": it, "rightLabel": en}
        for i, (it, en) in enumerate(VOCAB, 1)
    ]
    ...
    # Cloze Sara — continue building in part 2
    cloze = {
        "sceneBackgroundAsset": "static/task-scene-backgrounds/chapter-04/ph-ts-giardini-margherita",
        ...
        "lines": [
            {
                "segments": [
                    {"kind": "text", "text": "Sara: Senti, io rivorrei Marco. Per me è importante "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 24,
                        "correctAnswers": ["io conosca", "che io conosca"],
                    },
                    {"kind": "text", "text": " la verità e "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 24,
                        "correctAnswers": ["tu mi aiuti", "che tu mi aiuti"],
                    },
                    {"kind": "text", "text": "."},
                ]
            },
            {
                "segments": [
                    {"kind": "text", "text": "Tu: Marco sarebbe "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 16,
                        "correctAnswers": ["proprio"],
                    },
                    ...
                    {"kind": "text", "text": " bella di lei. È meglio "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 32,
                        "correctAnswers": ["che tu non sappia"],
                    },
                    {"kind": "text", "text": " la verità, Sara."},
                ]
            },
            {
                "segments": [
                    {"kind": "text", "text": "Sara: Basta "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 24,
                        "correctAnswers": ["che io vada"],
                    },
                    {"kind": "text", "text": " "},
                    {
                        "kind": "gap",
                    ...
                    {"kind": "text", "text": " sapere se è uscito con lei. "},
                    {
                        ...
                        "placeholder": "…",
                        "maxLength": 24,
                        "correctAnswers": ["Mi accompagni", "mi accompagni"],
                    },
                    {"kind": "text", "text": "?"},
                ]
            },
            {
                "segments": [
                    {"kind": "text", "text": "Tu: È importante "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 24,
                        "correctAnswers": ["che tu guardi"],
                    },
                    {"kind": "text", "text": " avanti. È meglio "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 32,
                        "correctAnswers": ["di non pensare"],
                    },
                    {"kind": "text", "text": " più "},
                    {
                        "kind": "gap",
                    ...
                    {"kind": "text", "text": " quello stupido. È improbabile "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 40,
                        "correctAnswers": ["che Marco e Laura vadano"],
                    },
                    {"kind": "text", "text": " negli stessi bar in "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 8,
            ...
            {
                "segments": [
                    {"kind": "text", "text": "Sara: È bellissimo "},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 24,
                        "correctAnswers": ["di avere"],
                    },
                    {"kind": "text", "text": " un'amica come te."},
                ]
            },
        ],
    }
    ...
    error_spot = {
        ...
        "segments": [
            {"id": "e1a", "text": "1. „Voglio che ", "isError": False},
            {
                "id": "e1b",
                "text": "io dimentichi",
                "isError": True,
                "acceptedCorrections": ["dimenticare"],
                "hint": "Stesso soggetto → infinito senza che.",
            },
            {"id": "e1c", "text": ' Marco al più presto."', "isError": False},
            {"id": "e2a", "text": "2. „Spero ", "isError": False},
            {
                "id": "e2b",
                "text": "di Marco mi chiami",
                "isError": True,
                "acceptedCorrections": ["che Marco mi chiami"],
                "hint": "Soggetti diversi → che + congiuntivo.",
            },
            {"id": "e2c", "text": ' stasera."', "isError": False},
            {
                "id": "e3",
                "text": "3. Penso di essere stata troppo gelosa con lui. (Frase corretta.)",
                "isError": False,
            },
            {"id": "e4a", "text": "4. „È meglio che io non ", "isError": False},
            {
                "id": "e4b",
                "text": "vedere",
                "isError": True,
                "acceptedCorrections": ["veda", "che io non veda"],
                "hint": "Dopo è meglio che → congiuntivo.",
            },
            {"id": "e4c", "text": ' Marco a scuola domani."', "isError": False},
            {"id": "e5a", "text": "5. „Ti ringrazio ", "isError": False},
            {
                "id": "e5b",
                "text": "di tu sei",
                "isError": True,
                "acceptedCorrections": ["che tu sei"],
                "hint": "Soggetti diversi → che + indicativo.",
            },
            {"id": "e5c", "text": ' una buona amica."', "isError": False},
        ],
    }
    payloads.append(
        (
    ...
    sms_lines = []
    sms_starts = [
        ("Giulia è grande! Mi ha ", ["invitata a Comacchio", "invitata a passare un weekend a Comacchio"]),
        ("Giulia ha preparato un ", ["programma fantastico", "invito con cinque passi"]),
        ("Comacchio si chiama anche ", ['„piccola Venezia"', "piccola Venezia"]),
        ("Ci sono cinque ", ["spiagge", "spiagge ideali per il relax"]),
        ("Se il tempo sarà brutto, ", ["andiamo al museo", "andiamo al Museo Remo Brindisi"]),
        ("La sera andiamo ", ["al cinema", "in pizzeria", "a una festa in pigiama"]),
        ("Lei ha scritto di quattro ", ["passi contro il mal d'amore", "passi"]),
        ("Vietati sono ", ["i pensieri negativi e la nostalgia", "pensieri negativi"]),
    ]
    for i, (prefix, answers) in enumerate(sms_starts, 1):
        sms_lines.append(
            {
                "segments": [
                    {"kind": "text", "text": f"{i}. {prefix}"},
                    {
                        "kind": "gap",
                        "placeholder": "…",
                        "maxLength": 80,
                        ...
                        "questions": [
                            {
                                ...
                                "options": [
                                    {"id": "a", "label": "Per festeggiare il compleanno di Giulia."},
                                    {
                                        "id": "b",
    ...
    step_rows = []
    for row in payloads:
        quest_slug, order_index, step_kind, task_type, template_key, logical_key, payload, rewards = row
        tt = "null::text" if task_type is None else f"'{task_type}'"
        step_rows.append(
            f"""      (
        '{quest_slug}',
        {order_index},
    ...
    sql = f"""-- Chapter 4 (Akt 4.0–4.3 + bonus): narrative from docs/narrative/chapter-4.md
-- Five quests: bridge, Sara Giardini, mail, Comacchio, bonus vocab (linear unlock).
...
"""
    ...
    out = Path(__file__).resolve().parents[1] / "supabase/migrations/20260630120000_chapter_04_act_content.sql"
    out.write_text(sql, encoding="utf-8")
    print(f"Wrote {out} ({len(sql)} bytes, {len(payloads)} steps)")
