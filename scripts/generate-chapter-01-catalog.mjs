      ...
      lines: [
        {
          segments: [
            ...
            { kind: "text", text: " (andare, io) in campeggio con la mia famiglia al Lago di Garda. " },
            gap(["Era", "era"]),
            { kind: "text", text: " (essere) la prima volta che " },
            gap(["vedevamo", "abbiamo visto", "Vedevamo", "Abbiamo visto"]),
            { kind: "text", text: " (vedere, noi) quel lago e ci " },
            gap(["è piaciuto", "È piaciuto"]),
            { kind: "text", text: " (piacere) moltissimo. Ogni mattina " },
            gap(["facevo", "Facevo"]),
            { kind: "text", text: " (fare, io) colazione con vista sull'acqua, poi " },
            gap(["andavamo", "Andavamo"]),
            { kind: "text", text: " (andare, noi) in spiaggia. Il tempo " },
            gap(["era", "Era"]),
            ...
            { kind: "text", text: " (dovere, noi) rimanere in tenda. Una sera " },
            gap(["ho conosciuto", "Ho conosciuto"]),
            { kind: "text", text: " (conoscere, io) un ragazzo italiano di Verona: " },
            gap(["abbiamo parlato", "Abbiamo parlato"]),
            { kind: "text", text: " (parlare, noi) per ore, anche se il mio italiano non " },
            gap(["era", "Era"]),
            { kind: "text", text: " (essere) ancora perfetto. Quando " },
            gap(["sono tornato", "sono tornata", "Sono tornato", "Sono tornata"]),
            { kind: "text", text: " (tornare, io) a casa, " },
            gap(["mi sentivo", "Mi sentivo"]),
            { kind: "text", text: " (sentirsi, io) un po' triste, ma anche contento/a perché presto " },
            gap([
              "partivo",
              "Partivo",
              "sarei partito",
            ...
            { kind: "text", text: " (partire, io) per Bologna." },
          ],
        },
      ],
    },
  ...
  content: {
    ...
    task: {
      ...
      segments: [
        {
          id: "a1",
          text: "In Italia, se vuoi risparmiare al bar,",
          isError: false,
        },
        {
          id: "a3",
        ...
        {
          id: "a4",
          text: " : il prezzo è lo stesso che al banco.",
          isError: false,
        },
        {
          id: "a4b",
          text: " Per quanto riguarda il caffè,",
          isError: false,
        },
        {
          id: "a5",
        ...
        {
          id: "a6",
          text: " , anche dopo pranzo e dopo cena.",
          isError: false,
        },
        {
          id: "a6b",
          text: " Al ristorante, quando arrivi,",
          isError: false,
        },
        {
          id: "a6c",
        ...
        {
          id: "a12",
          text: " . La mancia non è obbligatoria,",
          isError: false,
        },
        {
          id: "a12b",
          text: " ma sulla ricevuta si trova spesso il \"coperto\",",
          isError: false,
        },
        {
          id: "a12c",
          text: " una piccola somma per il pane e il servizio.",
          isError: false,
        },
      ],
    },
...
writeJson("quests/quest-03/scenes/04.json", {
      ...
      lines: [
        {
          segments: [
            ...
            { kind: "text", text: " (dare, lui) tantissimi compiti già il primo giorno … " },
            gap(["gli abbiamo detto", "Gli abbiamo detto"]),
            { kind: "text", text: " (dire, noi) che non è giusto, ma lo conosci, non " },
            gap(["gli", "Gli"]),
            { kind: "text", text: " interessa. Ti salutano i miei genitori, a pranzo " },
            gap(["mi hanno detto", "Mi hanno detto"]),
            { kind: "text", text: " (dire, loro) che " },
            gap(["gli hai mandato", "Gli hai mandato"]),
            { kind: "text", text: " (mandare, tu) un'e-mail. E poi Giulia …! " },
            gap(["le ho promesso", "Le ho promesso"]),
            { kind: "text", text: " (promettere, io) di mandar" },
            gap(["ti", "Ti"]),
  ...
  scoring: taskScoring("cloze", { maxSlices: 5 }),
});
