...
{
    /// <summary>Resources paths (no extension) for navigation chrome UXML under LearningToolkit/Templates/Parts.</summary>
    internal static class ToolkitNavigationTemplatePaths
    {
