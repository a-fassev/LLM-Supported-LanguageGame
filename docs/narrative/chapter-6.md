**Storyline – Versione Italiana (Atto 6, testo completo)** 
...
Compito 3: con LLM (freetext valutato con criteri rigidi). 
...
**Compito 3 — pratica 4 (p. 114-115): diretto -> indiretto** 
...
Testo compito direttamente sotto il titolo: Scrivi 3-5 frasi al discorso indiretto al presente partendo dalle risposte dell’autore. 

Soluzione diretta (modello): Abbiamo domandato a D'Avenia di dirci il titolo dell'ultimo libro che ha letto e lui ha risposto che ha appena finito di rileggere l'Odissea di Omero. Quando gli abbiamo chiesto perché ha scelto un tema così difficile per Bianca come il latte rossa come il sangue ha spiegato che vita e morte sono gli unici temi che non lo annoiano. Ha affermato che non si identifica con il personaggio del professore, ma che in ogni personaggio c’è sempre un po’ dello scrittore. Ha aggiunto che lui vive sempre in modo eccitante l’inizio e la fine di ogni libro e che, quando non scrive, insegna. Non è sicurose oggi scrive qualcosa, perché da una settimana è piuttosto pigro. Lui consiglia ai giovani scrittori di scrivere tanto, di non avere mai paura e di leggere moltissimo. Ha anche detto che il suo nuovo progetto è ancora un segreto, ma che presto ne sentiremo parlare. 

Tipologia: freetext valutato 

Categoria: Con LLM – Freitext (bewertet) 

Istruzione: Scrivi 3-5 frasi al discorso indiretto al presente usando le risposte dell’autore. 

Criteri di valutazione: 

1) formula introduttiva corretta (ha detto che / ha spiegato che ...), 

2) adattamento corretto di tempi e pronomi, 

3) almeno tre contenuti fedeli al testo originale. 
...
Testo compito direttamente sotto il titolo: Completa le frasi con la messa in rilievo e motiva le scelte. 

Soluzione diretta (modello): A Trapani è la città barocca che vorrei vedere perché questa città non l’ho vista ancora. Non sono le saline che mi interessano perché le saline le ho visitate già tante volte. A Monreale non è la Cattedrale di Santa Maria Nuova che mi interessa perché la Cattedrale la vedo su quasi ogni cartolina della città. A Piazza Armerina sono i mosaici che vorrei vedere perché i mosaici li trovo affascinanti. A Palermo è il Palazzo della Giustizia che vorrei visitare perché questo posto l’ho visto tante volte nei documentari su Giovanni Falcone. 

Tipologia: completamento frasi 

Categoria: Senza LLM – Lückentext 

Istruzione: Completa quattro frasi con la messa in rilievo (è ... che / non sono ... che ...). 

Starter: 

1) "A Trapani è ______ che vorrei vedere perché ..." 

2) "Non sono ______ che mi interessano perché ..." 

3) "A Piazza Armerina sono ______ che vorrei vedere perché ..." 

4) "A Palermo è ______ che vorrei visitare perché ..." 

Fonte: Scambio 2 plus, p. 122/123 (informarsi 3 + pratica 4 in un unico compito). 
...
[Narratore] In piazza c’è un grande quiz pubblico sull’Italia. Tutti partecipano: studenti, famiglie, turisti. 
...
[Narratore] Hai finito il quiz. Lo zaino è completo e in camera compaiono tutti gli oggetti finali. 
