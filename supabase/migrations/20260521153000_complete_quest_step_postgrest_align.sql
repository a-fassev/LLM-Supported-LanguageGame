-- Applies to databases that picked up an earlier 3-arg revision of complete_quest_step_task.
-- Drops that overload so PostgREST matches the canonical 4-parameter signature expected by apps/web.
