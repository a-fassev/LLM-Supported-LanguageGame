  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <CardContent className="space-y-3.5 px-0">
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              value={username}
              readOnly
              className="h-10 rounded-md border border-[#8f5a33]/20 bg-[#fffaf1]/88 px-3.5 text-[#3d1b0f] shadow-[inset_0_1px_2px_rgba(82,39,14,0.06),0_1px_0_rgba(255,255,255,0.7)] focus-visible:border-[#b85c22]/65 focus-visible:ring-3 focus-visible:ring-[#d77a32]/20"
            />
            <Button
              className="h-10 rounded-md border border-[#8f5a33]/22 bg-[#fff8eb]/58 px-3.5 font-semibold text-[#5a2612] shadow-sm shadow-[#5d2b0e]/8 hover:bg-[#fff3de] hover:text-[#3d1b0f]"
              type="button"
              variant="outline"
              onClick={onRegenerate}
              disabled={pending || loadingUsername}
            >
              Rigenera
            </Button>
          </div>
        ...
        <div className="space-y-2">
          <Label className="font-semibold text-[#5a2612]" htmlFor="passwordConfirm">
            {authUiLabels.repeatPassword}
          </Label>
          <Input
            id="passwordConfirm"
            type="password"
      ...
      <CardFooter className="flex flex-col gap-2 border-0 bg-transparent px-0 pb-0">
        <Button
          ...
          type="submit"
          disabled={pending || loadingUsername || username.length < 3}
        >
